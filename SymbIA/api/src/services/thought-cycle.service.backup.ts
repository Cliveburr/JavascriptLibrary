...
export class ThoughtCycleService {
  ...
  /**
   * Performs the specified action with progress callback
   * @param action The action to perform
   * @param ctx The current context
   * @param data Additional data for the action
   * @param onProgress Callback function to receive progress updates
...
The cycle processed the user's request and executed the necessary actions to fulfill it.`;
   ...
   */
  private async saveMemory(ctx: ThoughtCycleContext, data?: any, onProgress?: (message: string) => void): Promise<string> {
   ...
   */
  private async editMemory(ctx: ThoughtCycleContext, data?: any, onProgress?: (message: string) => void): Promise<string> {
   ...
   */
  private async deleteMemory(ctx: ThoughtCycleContext, data?: any, onProgress?: (message: string) => void): Promise<string> {
   ...
   */
  private async searchMemory(ctx: ThoughtCycleContext, data?: any, onProgress?: (message: string) => void): Promise<string> {
