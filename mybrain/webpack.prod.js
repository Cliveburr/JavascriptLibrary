...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "src\\main\\styles.css")
        ],
        "test": /\.css$/,
        "use": [
          {
  ...
  "plugins": [
    ...
    new AngularCompilerPlugin({
      "mainPath": "main\\main.ts",
      "platform": 0,
      "hostReplacementPaths": {
        "configuration\\config.ts": "configuration\\config.prod.ts"
      },
      "sourceMap": false,
