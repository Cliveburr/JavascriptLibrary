...
function watchStaticClient(args: Arguments, proj: BuildProject) {
    const projPath = path.resolve(args.rootFolder, proj.root, 'src');
...
export async function server(args: Arguments): Promise<void> {
